...
public class WebCoupon implements Serializable {
	...
	// ******************************************************************************
	/**
	 * convertToCoupon method are converting the coupon to a WebCoupon that can run
	 * in the Web.
	 */
	...
	/**
	 * convertToCoupon method are converting the coupon from a WebCoupon that can
	 * run in the Web to Coupon as in the DB
	 */
